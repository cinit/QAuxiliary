...
public class QQMsgBuilder {
    ...
    public static Object CopyToTYMessage(Object SourceObj) throws Exception {
        ...
        Object finalRecord = MMethod.CallMethod(null, MClass.loadClass("com.tencent.mobileqq.service.message.MessageRecordFactory"), "a",
    ...
    public static Object Copy_PokeMsg(Object raw) {
        try {
            ...
            MMethod.CallMethod(null, MClass.loadClass("com.tencent.mobileqq.service.message.MessageRecordFactory"),
                    "a", void.class,
                    new Class[]{MClass.loadClass("com.tencent.common.app.AppInterface"), MClass.loadClass("com.tencent.mobileqq.data.MessageRecord"),
                            String.class, String.class, int.class},
