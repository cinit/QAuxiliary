...
object HideClockInTip : CommonSwitchFunctionHook() {
    ...
    override fun initOnce(): Boolean {
        val grayTipsClass = Initiator.loadClass("com.tencent.mobileqq.aio.msglist.holder.component.graptips.common.CommonGrayTipsComponent")
        // 8.9.88(4852) .method private final t1()Lcom/tencent/mobileqq/aio/msglist/holder/component/graptips/GrayTipsTextView;
        val getTextViewMethod = grayTipsClass.getDeclaredMethod("t1")
